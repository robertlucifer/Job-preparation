...
# def name(self):
#     return self._name
# makes the vairable self.name read-only but still name can be change outside the class using the item._name = value expcitiy
# To make a varible completely private it need to initiated like self.__name = name. Which can used and assigned using methods. The self.__name can be used only in class level.
